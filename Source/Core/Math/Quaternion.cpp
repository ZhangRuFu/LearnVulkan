...
Quaternionf EulerToQuaternion(const Vector3& someEulerAngles, Math::RotationOrder order /*= math::kOrderUnityDefault*/)
{
...
Vector3 QuaternionToEuler(const Quaternionf& q, Math::RotationOrder order /*= math::kOrderUnityDefault*/)
{
...
void MatrixToQuaternion(const Matrix3x3& kRot, Quaternionf& q)
{
